...
class HomePageView(View, HomePageViewMixin, HomePageEditViewMixin):
    '''
    Třída pro zobrazení a úpravu obsahu domovské stránky.
    ...
    def get(self, request, *args, **kwargs):
        ...
        # Pokud URL končí "/edit/", přidáme formuláře pro editaci obsahu
