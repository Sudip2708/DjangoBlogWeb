...
def save_footer_data(form):
    '''
    Funkce pro uložení dat z formuláře do modelu sekce patičky.

    Tato metoda je volaná pohledem EditFooterSection a slouží k uložení dat z POST požadavku.
    '''

    # Načtení instance pro patičku
    instance = FooterSettings.singleton()

    # Uložení hodnoty do pole zobrazení patičky
    ...
    # Uložení hodnot url do slovníku pro sociální sítě
