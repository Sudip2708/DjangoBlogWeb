...
from users.utilities.shared.delete_image_file import delete_image_file
from users.utilities.shared.resize_and_square_crop_image import resize_and_square_crop_image
